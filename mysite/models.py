...
class project_plan(models.Model):
    ...
    proBuildStatus = models.IntegerField(default=0, verbose_name="生产部署状态(0:未部署,1:已部署,2:部署失败)")
    uatBuildStatus = models.IntegerField(default=0, verbose_name="预发部署状态(0:未部署,1:已部署,2:部署失败)")
